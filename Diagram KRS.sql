...
CREATE TABLE `sesi_kuliah_bentrok` (
  ...
  `id_bentrok` smallint(5) NOT NULL,
...
ALTER TABLE `tagihan_mhs` ADD FOREIGN KEY (`ta`) REFERENCES `tahun_ajaran` (`kode`);

ALTER TABLE `tagihan_mhs` ADD FOREIGN KEY (`nim_dinus`) REFERENCES `mahasiswa_dinus` (`nim_dinus`);

ALTER TABLE `ip_semester` ADD FOREIGN KEY (`ta`) REFERENCES `tahun_ajaran` (`kode`);

ALTER TABLE `ip_semester` ADD FOREIGN KEY (`nim_dinus`) REFERENCES `mahasiswa_dinus` (`nim_dinus`);

ALTER TABLE `krs_record` ADD FOREIGN KEY (`ta`) REFERENCES `tahun_ajaran` (`kode`);

ALTER TABLE `krs_record` ADD FOREIGN KEY (`kdmk`) REFERENCES `matkul_kurikulum` (`kdmk`);

ALTER TABLE `krs_record` ADD FOREIGN KEY (`id_jadwal`) REFERENCES `jadwal_tawar` (`id`);

ALTER TABLE `krs_record` ADD FOREIGN KEY (`nim_dinus`) REFERENCES `mahasiswa_dinus` (`nim_dinus`);

ALTER TABLE `krs_record_log` ADD FOREIGN KEY (`id_krs`) REFERENCES `krs_record` (`id`);

ALTER TABLE `krs_record_log` ADD FOREIGN KEY (`nim_dinus`) REFERENCES `mahasiswa_dinus` (`nim_dinus`);

ALTER TABLE `krs_record_log` ADD FOREIGN KEY (`kdmk`) REFERENCES `matkul_kurikulum` (`kdmk`);

ALTER TABLE `jadwal_tawar` ADD FOREIGN KEY (`kdmk`) REFERENCES `matkul_kurikulum` (`kdmk`);

ALTER TABLE `jadwal_tawar` ADD FOREIGN KEY (`id_hari1`) REFERENCES `hari` (`id`);

ALTER TABLE `jadwal_tawar` ADD FOREIGN KEY (`id_hari2`) REFERENCES `hari` (`id`);

ALTER TABLE `jadwal_tawar` ADD FOREIGN KEY (`id_hari3`) REFERENCES `hari` (`id`);

ALTER TABLE `jadwal_tawar` ADD FOREIGN KEY (`id_sesi1`) REFERENCES `sesi_kuliah` (`id`);

ALTER TABLE `jadwal_tawar` ADD FOREIGN KEY (`id_sesi2`) REFERENCES `sesi_kuliah` (`id`);

ALTER TABLE `jadwal_tawar` ADD FOREIGN KEY (`id_sesi3`) REFERENCES `sesi_kuliah` (`id`);

ALTER TABLE `jadwal_tawar` ADD FOREIGN KEY (`id_ruang1`) REFERENCES `ruang` (`id`);

ALTER TABLE `jadwal_tawar` ADD FOREIGN KEY (`id_ruang2`) REFERENCES `ruang` (`id`);

ALTER TABLE `jadwal_tawar` ADD FOREIGN KEY (`id_ruang3`) REFERENCES `ruang` (`id`);

ALTER TABLE `mhs_ijin_krs` ADD FOREIGN KEY (`ta`) REFERENCES `tahun_ajaran` (`kode`);

ALTER TABLE `mhs_ijin_krs` ADD FOREIGN KEY (`nim_dinus`) REFERENCES `mahasiswa_dinus` (`nim_dinus`);

ALTER TABLE `herregist_mahasiswa` ADD FOREIGN KEY (`nim_dinus`) REFERENCES `mahasiswa_dinus` (`nim_dinus`);

ALTER TABLE `herregist_mahasiswa` ADD FOREIGN KEY (`ta`) REFERENCES `tahun_ajaran` (`kode`);

ALTER TABLE `mhs_dipaketkan` ADD FOREIGN KEY (`nim_dinus`) REFERENCES `mahasiswa_dinus` (`nim_dinus`);

ALTER TABLE `sesi_kuliah_bentrok` ADD CONSTRAINT `FK_sesi_kuliah_bentrok` FOREIGN KEY (`id`) REFERENCES `sesi_kuliah` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `sesi_kuliah_bentrok` ADD CONSTRAINT `FK_sesi_kuliah_bentrok2` FOREIGN KEY (`id_bentrok`) REFERENCES `sesi_kuliah` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `tahun_ajaran` ADD FOREIGN KEY (`kode`) REFERENCES `tahun_ajaran` (`id`);

ALTER TABLE `daftar_nilai` ADD FOREIGN KEY (`nim_dinus`) REFERENCES `mahasiswa_dinus` (`nim_dinus`);

ALTER TABLE `daftar_nilai` ADD FOREIGN KEY (`kdmk`) REFERENCES `matkul_kurikulum` (`kdmk`);

ALTER TABLE `validasi_krs_mhs` ADD FOREIGN KEY (`nim_dinus`) REFERENCES `mahasiswa_dinus` (`nim_dinus`);

ALTER TABLE `validasi_krs_mhs` ADD FOREIGN KEY (`ta`) REFERENCES `tahun_ajaran` (`kode`);
